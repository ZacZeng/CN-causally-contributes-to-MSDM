function [ms, biases] = mf_sepk_nobias(d, p)
...
% and bounds. Further, it does not assume any biases.
%
...
if nargin < 2
    ...
    ms = struct();
    ms.p_min = [(0.00001*ones(1,c_num)) (0.001*ones(1,c_num)) 0.00001 0.001 (0.00001*ones(1,c_num)) (0.001*ones(1,c_num))   0   0   0   0];
    ms.p_max = [   (1000*ones(1,c_num))    (10*ones(1,c_num))    1000    10    (1000*ones(1,c_num))    (10*ones(1,c_num))   1   1   1 0.2];
    ms.p_ini = [sepk_p(1:(4*c_num+5)) sepk_p(end)];
    ms.p_w   = [          (2+150*cs.^3)  (0.02*ones(1,c_num))      20  0.03           (2+150*cs.^3)  (0.02*ones(1,c_num)) 0.2 0.2 0.2 0.1];
    ms.p_names = cat(2,...
