function [ms, biases] = mf_sepw(d, p)
...
% condition/coherence separately.
%
...
if nargin < 2
    ...
    ms = struct();
    ms.p_min = [(0.00001*ones(1,c_num)) (0.001*ones(1,c_num)) 0.00001 0.001      zeros(1,c_num) (0.001*ones(1,c_num))   0   0   0 (-5*ones(1,2*c_num+1))   0];
    ms.p_max = [   (1000*ones(1,c_num))    (10*ones(1,c_num))    1000    10       ones(1,c_num)    (10*ones(1,c_num))   1   1   1  (5*ones(1,2*c_num+1)) 0.2];
    ms.p_ini = sepk_p;
    ms.p_w   = [          (2+150*cs.^3)  (0.02*ones(1,c_num))      20  0.03 (0.2*ones(1,c_num))  (0.02*ones(1,c_num)) 0.2 0.2 0.2    (ones(1,2*c_num+1)) 0.1];
    ms.p_names = cat(2,...
