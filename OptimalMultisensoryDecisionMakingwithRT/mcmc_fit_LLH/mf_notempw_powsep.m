function [ms, biases] = mf_notempw_powsep(d, p)
%% returns the model predictions for given subject data and parameters
%
% this model does not perform optimal temporal weighting, while still
% combining the information optimally across cues. It assumes the k's and
% bounds to depend on coherence by
