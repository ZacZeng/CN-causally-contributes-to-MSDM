function [ms, biases] = mf_sepw_nobias(d, p)
...
% condition/coherence separately, and does not assume any biases.
%
...
% pl
%
% resulting in 4 x coh_num + 6 parameters.
%
...
if nargin < 2
    ...
    ms = struct();
    ms.p_min = [(0.00001*ones(1,c_num)) (0.001*ones(1,c_num)) 0.00001 0.001      zeros(1,c_num) (0.001*ones(1,c_num))   0   0   0   0];
    ms.p_max = [   (1000*ones(1,c_num))    (10*ones(1,c_num))    1000    10       ones(1,c_num)    (10*ones(1,c_num))   1   1   1 0.2];
    ms.p_ini = [sepk_p(1:(4*c_num+5)) sepk_p(end)];
    ms.p_w   = [          (2+150*cs.^3)  (0.02*ones(1,c_num))      20  0.03 (0.2*ones(1,c_num))  (0.02*ones(1,c_num)) 0.2 0.2 0.2 0.1];
    ms.p_names = cat(2,...
...
pl = p(4*c_num+6);
biases = struct('vis', zeros(1,c_num), 'vest', 0, 'comb', zeros(1,c_num));
