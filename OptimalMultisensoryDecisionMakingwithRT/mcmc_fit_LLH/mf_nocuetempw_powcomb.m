function [ms, biases] = mf_nocuetempw_powcomb(d, p)
...
if nargin < 2
    ...
    ms.p_ini = [  3000 45  1.50   3      40  0.25   1  0.30   7 0.2 0.2 0.2     zeros(1,2*c_num+1)   0];
    ms.p_w   = [   100  1  0.10 0.5      20  0.03   1  0.05 0.5 0.2 0.2 0.2    (ones(1,2*c_num+1)) 0.1];
    ms.p_names = cat(2,...
