function [ms, biases] = mf_sepk_powcomb(d, p)
...
if nargin < 2
    ...
    ms.p_min = [0.0001  0 0.001   0 0.00001 0.001   (0.0001*ones(1,c_num))   0 0.001   0   0   0   0 (-5*ones(1,2*c_num+1))   0];
    ms.p_max = [ 10000 50    10  10    1000    10     (1000*ones(1,c_num)) 200    10  10   1   1   1  (5*ones(1,2*c_num+1)) 0.2];
    ms.p_ini = [   750  2  0.25   3      40  0.25               k_comb_ini 100  0.25   4 0.2 0.2 0.2     zeros(1,2*c_num+1)   0];
    ms.p_w   = [    50  1  0.05 0.5      20  0.03  (2+0.001*k_comb_ini.^2)  10  0.05 0.5 0.2 0.2 0.2    (ones(1,2*c_num+1)) 0.1];
    ms.p_names = cat(2,...
