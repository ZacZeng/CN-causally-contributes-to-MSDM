...
% ======= Change the file directory===========
    winopen('D:\Paper_rawdata\Raw_data\CN\DataHub.xlsm');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ======= Change the file directory===========
handles.XlsData = ReadXls('D:\Paper_rawdata\Raw_data\CN\DataHub.xlsm',str2num(get(handles.sheetN,'string')),str2num(get(handles.headerN,'string')));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function_handles = Group_MicroStim_xls(data,get(handles.tolerance,'value'));
...
handles.level1_n = size(handles.function_handles,1); % The last one reserved for functions that is accessible to GROUP_GUI 
...
% --- Executes on button press in Duncan_data.
function Duncan_data_Callback(hObject, eventdata, handles)
% hObject    handle to Duncan_data (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function Fara_data_Callback(hObject, eventdata, handles)
% hObject    handle to Duncan_data (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
